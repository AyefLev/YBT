...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/register', component: RegisterPage },
  {
    ...
    children: [
      ...
      { path: 'observability', component: ObservabilityPage, meta: { permissions: ['log:view'], blockedRoles: ['teaching_manager'], pageMode: 'overview' } },
      { path: 'observability/token', component: ObservabilityPage, meta: { permissions: ['log:view'], blockedRoles: ['teaching_manager'], pageMode: 'token' } },
      { path: 'health', component: SystemHealthPage, meta: { permissions: ['log:view'], blockedRoles: ['teaching_manager'] } },
